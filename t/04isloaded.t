...
ok( is_mod_loaded('Test::More'), 'is_mod_loadewd() found Test::More' );
ok( is_mod_loaded('Module::Locate'), 'is_mod_loadewd() found Module::Locate') ;
...
ok(!is_pkg_loaded('an::unlinkely::pkg'), "is_pkg_loaded() didn't non-package" );
